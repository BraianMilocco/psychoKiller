...
class MyAccountManager(BaseUserManager):
    ...
    def create_user(self, email, username, last_name, professional_registration, phone_number=None, password=None):
        """
        ...
        user = self.model(email=self.normalize_email(email), username=username, last_name=last_name, professional_registration=professional_registration, phone_number=phone_number)
    ...
    def create_superuser(self, email, username, last_name, professional_registration, password, phone_number=None):
