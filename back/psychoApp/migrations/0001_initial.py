# Generated by Django 3.1.2 on 2021-04-10 21:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(max_length=50, verbose_name='Título')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('link', models.CharField(max_length=30, unique=True, verbose_name='Link')),
                ...
                ('template_test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='psychoApp.templatetest')),
                ('therapist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('options', models.ManyToManyField(blank=True, to='psychoApp.Option', verbose_name='Opciones')),
                ('template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='psychoApp.templatetest')),
            ],
            options={
